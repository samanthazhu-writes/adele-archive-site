const EDEN_TEXT = {
  zh: {
    ...
    downloadSimple: "DOWNLOAD_SIMPLE_CARD",
    downloadArchive: "DOWNLOAD_ARCHIVE_CARD",
    downloadFull: "DOWNLOAD_FULL_RECEIPT",
    copyShareText: "COPY_SHARE_TEXT",
    copied: "已复制分享文本。",
    copyFailed: "复制失败。请手动选择收据文本。",
    ...
    restartHint: "不同的维护选择会改变最终记录。你可以重新开始一次会话。",
    viewSystemIndices: "VIEW_SYSTEM_INDICES",
    hideSystemIndices: "HIDE_SYSTEM_INDICES",
    viewContentNote: "VIEW_FULL_CONTENT_NOTE",
    hideContentNote: "HIDE_FULL_CONTENT_NOTE",
    viewMaintenanceTrace: "VIEW_MAINTENANCE_TRACE",
    hideMaintenanceTrace: "HIDE_MAINTENANCE_TRACE",
    dossierIntro: "This record is part of The Adèle Archive.",
    dossierComingSoon: "PROJECT_DOSSIER_COMING_SOON",
    blockLabels: {
      eden: "[EDEN REVISION]",
      raw: "[RAW RESIDUE]",
      note: "[OPERATOR NOTE]"
  ...
  en: {
    ...
    copyFailed: "COPY_FAILED_SELECT_TEXT_MANUALLY",
    restart: "RESTART_SESSION",
    switchLang: "切换到中文",
    resultExplanation: [
      "EDEN did not only read your final command.",
      "It also read how you maintained the archive."
    ],
    restartHint: "Different maintenance choices may produce a different final record. You may restart the session.",
    viewSystemIndices: "VIEW_SYSTEM_INDICES",
    hideSystemIndices: "HIDE_SYSTEM_INDICES",
    viewContentNote: "VIEW_FULL_CONTENT_NOTE",
    hideContentNote: "HIDE_FULL_CONTENT_NOTE",
...
const EDEN_DATA = {
  ...
  tasks: [
    ...
    },
    {
      ...
      displayName: { zh: "保护", en: "PROTECTION" },
